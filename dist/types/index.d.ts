...
export type TimeFormatter = (currentLocale: string, d: Date | number, options?: IntlFormatterOptions<Intl.DateTimeFormatOptions>) => string;
export type DateFormatter = (currentLocale: string, d: Date | number, options?: IntlFormatterOptions<Intl.DateTimeFormatOptions>) => string;
export type NumberFormatter = (currentLocale: string, d: number, options?: IntlFormatterOptions<Intl.NumberFormatOptions>) => string;
...
export type TypedFormat<T = string> = Readable<(id: T, options?: MessageObject | undefined) => string>;
